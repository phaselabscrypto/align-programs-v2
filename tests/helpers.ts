import { ASSOCIATED_TOKEN_PROGRAM_ID, createAssociatedTokenAccountInstruction, createInitializeMintInstruction, createMintToCheckedInstruction, getAssociatedTokenAddress, getAssociatedTokenAddressSync, getMinimumBalanceForRentExemptMint, MintLayout, TOKEN_PROGRAM_ID } from "@solana/spl-token"
import { createCreateMasterEditionV3Instruction, createVerifyInstruction, createCreateMetadataAccountV3Instruction, CreateMasterEditionArgs, CreateMasterEditionV3InstructionAccounts, createMintInstruction, createCreateInstruction, CreateMetadataAccountArgsV3, CreateMetadataAccountV3InstructionAccounts, createSetAndVerifySizedCollectionItemInstruction, PROGRAM_ADDRESS, PROGRAM_ID, SetAndVerifySizedCollectionItemInstructionAccounts, TokenStandard, VerifyInstructionAccounts, VerifyInstructionArgs, VerificationArgs } from "@metaplex-foundation/mpl-token-metadata"
...
export const getMetadataAddress = async (mint: web3.PublicKey) => {
  ...
  export const getEditionMarkAddress = async (master_mint: web3.PublicKey, edition: number) => {
    const [address, bump] = await web3.PublicKey.findProgramAddress(
      [
        utils.bytes.utf8.encode("metadata"),
        new web3.PublicKey(PROGRAM_ADDRESS).toBuffer(),
  ...
  export const mintNft = async (
    ...
    const createMetadataAccountArgs: CreateMetadataAccountArgsV3 = {
      data: {
        name: "name",
        symbol: "DS",
        uri: uri ? uri : "https://shdw-drive.genesysgo.net/Avy3TVpFP9M1mjrDFZdswBhdA7kZaJnyiLBPi1XRYqRa/collectionMetadata_49gW2U7ftZ724rMk6bswVayCrTNAu9aGcMiKnSj8XPAG6i5k5pxTtNSUVKZyeWFpn8npz4CVsqzL7CqXfgW33fAM.json",
        sellerFeeBasisPoints: 10000,
        creators: null,
        collection: {
          key: collection,
