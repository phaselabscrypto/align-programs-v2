...
pub mod state_controller {
    ...
    pub fn on_vote_v0(
        ctx: Context<instructions::on_vote_v0::OnVoteV0>,
        args: instructions::on_vote_v0::VoteArgsV0,
    ) -> Result<Option<Vec<u16>>> {
        instructions::on_vote_v0::handler(ctx, args)
    }

    pub fn resolve_v0(ctx: Context<instructions::resolve_v0::ResolveV0>) -> Result<()> {
